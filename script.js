...
const allActions = [
    ...
    "As-tu déjà eu des relations sexuelles avec une personne qui ne parlait pas ta langue ? Si oui, raconte!",
    ...
    "{player} et {randomPlayer} doivent jouer à 'Je n'ai jamais' (10 fois).",
